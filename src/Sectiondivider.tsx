  ...
  return (
    <>
      <style>{`
        ...
        .cpd-scan-vline { width:1px; height:32px; background:rgba(255,255,255,0.15); flex-shrink:0; }
        .cpd-scan-label {
          font-family: 'Inter', sans-serif;
          font-size: 0.65rem;
          font-weight: 600;
        ...
        .cpd-tc-rec {
          ...
          animation: cpdRec 1s step-end infinite;
        }
        ...
        .cpd-slash-bar { height:1px; flex:1; }
        ...
        @media (max-width:600px) {
          ...
          .cpd-scan-label,.cpd-reel-label,.cpd-tc-label,.cpd-slash-text,.cpd-fs-label { font-size:0.58rem; letter-spacing:4px; }
          .cpd-tc { height:48px; }
